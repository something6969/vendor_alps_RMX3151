...
PHX_LOG_DIR="/data/persist_log/oplusreserve/media/log/hang_oplus"
OPLUSRESERVE2_MOUNT_POINT="/data/persist_log/oplusreserve/media/log/hang_oplus"
...
TMP_DIR="/data/oplusbootstats/phoenix_$(date +"%Y%m%d%H%M%S_%N")"
...
function phx_log_native_helper_main()
{
    ...
    #Liang.Zhang@PSW.TECH.Stability, 2019/01/15, Add for save recovery_info to oplusreserve2
