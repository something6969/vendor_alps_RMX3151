...
#ifndef ODM_HQ_EDIT
#wangcheng@ODM.Multimedia.LCD  2021/04/22 add for Space-B LCD bring up
...
CUSTOM_HAL_IMGSENSOR = s5kjn1_mipi_raw ov64b40_mipi_raw hi1634q_mipi_raw s5k3p9spsunny_mipi_raw gc02m1hlt_mipi_raw gc02m1shine_mipi_raw gc02m1bsy_mipi_raw ov02b1b_mipi_mono
CUSTOM_HAL_LENS = dw9718taf dw9800waf
CUSTOM_HAL_MAIN2_IMGSENSOR = gc02m1hlt_mipi_rawgc02m1bsy_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kjn1_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9718taf dw9800waf
CUSTOM_HAL_MSENSORLIB = akm
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = hi1634q_mipi_raw s5k3p9spsunny_mipi_raw
CUSTOM_HAL_SUB2_IMGSENSOR = ov02b1b_mipi_mono
...
CUSTOM_KERNEL_IMGSENSOR = s5kjn1_mipi_raw ov64b40_mipi_raw hi1634q_mipi_raw s5k3p9spsunny_mipi_raw gc02m1hlt_mipi_raw gc02m1shine_mipi_raw gc02m1bsy_mipi_raw ov02b1b_mipi_mono
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9718taf dw9800waf
CUSTOM_KERNEL_LINEARACCEL_SENSOR = yes
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_IMGSENSOR = gc02m1hlt_mipi_rawgc02m1bsy_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kjn1_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9718taf dw9800waf
...
#ifdef ODM_HQ_EDIT
#qiantao@ODM.HQ.Multimeida.Audio 2021/04/22 added for mic and spk  bring up
CUSTOM_KERNEL_SOUND = mt6366
#endif
CUSTOM_KERNEL_STATIONARY_SENSOR = yes
CUSTOM_KERNEL_STEP_COUNTER = yes
CUSTOM_KERNEL_STEP_DETECTOR = no
CUSTOM_KERNEL_SUB_IMGSENSOR = hi1634q_mipi_raw s5k3p9spsunny_mipi_raw
CUSTOM_KERNEL_SUB2_IMGSENSOR = ov02b1b_mipi_mono
...
#wangcheng@ODM.Multimedia.LCD  2021/04/29 add for Space-B open AAL
MTK_AAL_SUPPORT = yes
...
#Jingtao.Sun@MULTIMEDIA.AUDIODRIVER.ADSP 2021/05/27 add sixth aurisys
...
#XinFeng.Zhu@CONNECTIVITY.BT.Basic.Customize.1591382, 2021/05/27, Add for disabling SAP profile.
...
#LiangXiao@CONNECTIVITY.WIFI.BASIC, 2019/04/11 [add for Bringup P95R project]
...
#huxiang@ODM.HQ.Multimeida.Codec,2021/05/11,Add for widevine key
...
#endif
#ifdef ODM_HQ_EDIT
#zhangpanpan@ODM.HQ.Android.Performance 2021/05/12 added for remove MTK duraspeed
...
##ifdef VENDOR_EDIT
#guohuiqing@ODM.HQ.BSP.DISPLAY 2021/06/18 add color mode support
MTK_DISP_COLOR_SUPPORT = 1
##endif  /*VENDOR_EDIT*/
##ifndef VENDOR_EDIT
#Yue.Wei@PSW.NW.SIM, 2021/04/22, Add for VSIM enable
...
#ifdef OPLUS_BUG_CONFIG
#sunhuan@NW.IMS.2307846, 2021/10/21 modify for vowifi reg for airtel roaming
MTK_MOBILE_MANAGEMENT = no
#endif /* ifdef OPLUS_BUG_CONFIG */
...
MTK_PROJECT_DTB_NAMES = mediatek/oplus6781_21684
...
#PAN.YIN@MULTIMEDIA.DISPLAY.SERVICE, 2021/06/07, Add for OSIE support
MTK_VIDEO_ENHANCEMENT = yes
MTK_VIDEO_TRANSITION = yes
MTK_PQ_VIDEO_WHITELIST_SUPPORT = yes
#Add for OSIE support
...
##ifndef VENDOR_EDIT
#Yue.Wei@PSW.NW.SIM, 2021/04/22, Add for SIM_HOT_SWAP enable
#modify for Add for SIM_HOT_SWAP enable
...
#Yang.Tan@BSP.Fingerprint.Secure, 2020/10/17, add for open trustonic tee, config tee.
MTK_TEE_SUPPORT = yes
MTK_TEE_GP_SUPPORT = yes
#endif /* OPLUS_FEATURE_FINGERPRINT */
#ifdef OPLUS_FEATURE_BOOT_SECURITY
#Dongnan.Wu@BSP.Fingerprint.Secure, 2020/06/19, add for support TEE_POLLING config.
...
#ifdef OPLUS_FEATURE_VOW_WAKEUP
#Wang.Kun@MULTIMEDIA.AUDIODRIVER.FEATURE, 2021/01/09, modify for VOW
MTK_VOW_SUPPORT = yes
...
#endif /* OPLUS_FEATURE_VOW_WAKEUP */
...
#RenXiaodong@CONNECTIVITY.GPS.NLP.STABILITY.1875019, 2019/03/06, Add for remove mtk nlp
MTK_NLP_SUPPORT = no
#endif/* OPLUS_BUG_STABILITY */
